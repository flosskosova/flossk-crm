...
namespace FlosskMS.Data.Migrations
{
    ...
    [Migration("20260614133000_SetPushSubscriptionApprovalDefaultFalse")]
    partial class SetPushSubscriptionApprovalDefaultFalse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("GoogleFormTitle")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseInstructor", b =>
                {
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseResourceFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("CourseResourceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CourseResourceId", "FileId")
                        .IsUnique();

                    b.ToTable("CourseResourceFiles");
                });

            modelBuilder.Entity("FlosskMS.Data.Entities.CourseReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseVoucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<string>>("RedeemedByEmails")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.FormResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CourseId", "SubmittedAt");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.Course", b =>
                {
                    ...
                    b.HasOne("FlosskMS.Data.Entities.Project", "Project")
                        .WithOne("Course")
                        .HasForeignKey("FlosskMS.Data.Entities.Course", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseInstructor", b =>
                {
                    b.HasOne("FlosskMS.Data.Entities.Course", "Course")
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseResource", b =>
                {
                    b.HasOne("FlosskMS.Data.Entities.CourseModule", "CourseModule")
                        .WithMany("Resources")
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.CourseResourceFile", b =>
                {
                    b.HasOne("FlosskMS.Data.Entities.CourseResource", "CourseResource")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.Event", b =>
                {
                    b.HasOne("FlosskMS.Data.Entities.Project", "Project")
                        .WithOne("Event")
                        .HasForeignKey("FlosskMS.Data.Entities.Event", "ProjectId")
                        .OnDelete(DeleteBehavior.SetNull);
