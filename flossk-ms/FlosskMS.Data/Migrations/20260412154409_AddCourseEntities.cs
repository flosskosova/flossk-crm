        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommunicationChannels = table.Column<List<string>>(type: "text[]", nullable: false, defaultValueSql: "'{}'"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseResources_CourseModules_CourseModuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseReviews_CourseModules_CourseModuleId",
                        column: x => x.CourseModuleId,
                        principalTable: "CourseModules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseResources_CourseModuleId",
                table: "CourseResources",
                column: "CourseModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseReviews_CourseModuleId",
                table: "CourseReviews",
                column: "CourseModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseReviews_SubmittedAt",
                table: "CourseReviews",
                column: "SubmittedAt");
