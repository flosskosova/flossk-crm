...
namespace FlosskMS.Data.Migrations
{
    ...
    [Migration("20260304135334_AddRepairTracking")]
    partial class AddRepairTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.InventoryItem", b =>
                {
                    ...
                    b.Property<DateTime?>("DamageReportedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DamageReportedByUserId")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RepairedByUserId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("DamageReportedByUserId");
            ...
            modelBuilder.Entity("FlosskMS.Data.Entities.InventoryItem", b =>
                {
                    ...
                    b.HasOne("FlosskMS.Data.Entities.ApplicationUser", "DamageReportedByUser")
                        .WithMany()
                        .HasForeignKey("DamageReportedByUserId");

                    b.HasOne("FlosskMS.Data.Entities.ApplicationUser", "RepairedByUser")
                        .WithMany()
                    ...
                    b.Navigation("DamageReportedByUser");
