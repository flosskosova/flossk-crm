...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, DividerModule, SkeletonModule, TagModule, ButtonModule, TooltipModule],
    template: `
    <div class="card">
...
export class UserSettings implements OnInit {
    ...
    loadPage(page: number): void {
        ...
        this.logService.getLogs({ userId, page, pageSize: this.pageSize }).subscribe({
            next: (res) => {
                this.logs = res.data;
