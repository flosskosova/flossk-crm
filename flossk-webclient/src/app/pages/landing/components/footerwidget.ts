                ...
                <div class="col-span-12 md:col-span-10">
                    <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100" routerLink="/privacy">Privacy Policy</a>
                            <a class="leading-normal text-xl block cursor-pointer text-surface-700 dark:text-surface-100" routerLink="/terms">Terms of Service</a>
                        </div>
                    </div>
                </div>
            </div>
